...
def calculateAPScore(prediction,target,nThreads=5,IOU_tau=0.5):
    ...
    #Score calculation
    #tp the prediction is true and the (prediction)value is positive
    #fp the prediction is incorrect and the value is positive
    #fn the prediction is incorrect and the value is negative 
    true_postive = 0
    false_positive = 0
    false_negative = 0
    for pInstance in pred_inst_list:
